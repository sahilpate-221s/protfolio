          ...
          <div className="heroText h-full w-full z-30 flex flex-col md:justify-center">
            ...
            <div className="buttons max-sm:absolute bottom-10 w-full flex max-sm:items-center max-md:flex-col text-white gap-3 text-[10px] tracking-widest pl-4 md:pl-5 mt-5">
              ...
              >
                <motion.button
                  ...
                  className="text-color2 border-2 border-color2 hover:bg-color2 hover:text-color3 rounded-3xl w-[14rem] md:w-[12rem] uppercase text-center font-semibold cursor-pointer py-2 relative overflow-hidden group"
                >
                  <span className="relative z-10">Get in Touch</span>
                  <motion.span 
                    className="absolute inset-0 bg-color2 transform scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-300"
                    initial={{ scaleX: 0 }}
                    whileHover={{ scaleX: 1 }}
                  />
                </motion.button>
            ...
            <div className="social-icons w-20 flex justify-center items-center gap-3 h-10 mt-5 ml-5">
              <motion.a
                ...
                transition={{ duration: 1 }}
                className=""
                href="https://www.linkedin.com/in/sahil-1patel/"
                target="_blank"
              >
                <img
              ...
              <motion.a
                ...
                className=""
                href="https://github.com/sahilpate-221s"
                target="_blank"
              >
                <img
