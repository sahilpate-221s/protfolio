...
export const Navbar = () => {
  ...
  return (
    <>
      <div className="flex w-full justify-center bg-[#121212]">
        <nav className="flex h-[15vh] w-full justify-between px-5 py-10 max-w-[60rem]">
          <div className="logo">
            <h1 className="text-white text-2xl md:text-3xl font-bold">Sahil.dev</h1>
          </div>
          <div onClick={() => setToggle(!toggle)} className="menu md:hidden">
            <img className="w-8" src={menu} alt="" />
          </div>
          <div className="menu-items hidden md:flex gap-8 text-xs text-white/80 uppercase z-30">
            <a href="#Home" className="menu-item cursor-pointer hover:text-white transition-colors duration-300">
              Home
            </a>
            <a href="#Projects" className="menu-item cursor-pointer hover:text-white transition-colors duration-300">
              Projects
            </a>
            <a href="#About" className="menu-item cursor-pointer hover:text-white transition-colors duration-300">
              About Us
            </a>
          </div>
        </nav>
      ...
      <div
        className={`${
          toggle ? "flex" : "hidden"
        } flex-col items-center fixed top-0 w-full h-screen rounded-md bg-[#121212] z-50 backdrop-blur-md gap-y-20`}
      >
        <div className="close">
          <img
